...
pub fn drive_coil_launchers(
    mut weapons: Query<(Entity, &mut CoilLauncherComponent, &mut WeaponState, &WeaponConfig, &PendingWeaponInput)>,
    ...
    super::drive_weapon_inputs(&mut weapons, net_ids, world, commands, quic, sound_queue, possessed, camera_fx, id_counter, predicted, update_coil_launcher);
}
